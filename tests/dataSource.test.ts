...
describe('DataSource', () => {
	...
	describe('getCommits', () => {
		...
		it('Should return the commits (master & develop branches)', async () => {
			...
			// Run
			const result = await dataSource.getCommits('/path/to/repo', ['master', 'develop'], null, null, 300, true, true, false, false, CommitOrdering.AuthorDate, ['origin'], [], [], false);
		...
		it('Should return the commits (no more commits)', async () => {
			...
			// Run
			const result = await dataSource.getCommits('/path/to/repo', null, null, null, 2, true, true, false, false, CommitOrdering.Topological, ['origin'], [], [], false);
